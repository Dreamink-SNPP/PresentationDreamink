...
Patrón consistente: exploración creativa no estructurada ("proceso vómito") seguida de organización estructural rigurosa.
...
**Tres dificultades técnicas universales:**
- Información dispersa en múltiples herramientas
- Falta de visualización integrada
- Ausencia de vinculación dinámica entre elementos narrativos
...
- Destacar la fundamentación cognitiva de las preferencias
- Conectar hallazgos con la propuesta de solución (DREAMINK)
- Mencionar que estos patrones justifican decisiones de diseño
